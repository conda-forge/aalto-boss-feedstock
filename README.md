...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/aalto-boss-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aalto-boss-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install aalto-boss
```
...
It is possible to list all of the versions of `aalto-boss` available on your platform:
...
```
pixi search aalto-boss --channel conda-forge
```
